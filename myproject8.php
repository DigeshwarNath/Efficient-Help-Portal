...
<div class="imgcontainer">
  ...
  <div class="container">
    ...
    <label for="gndr"><b>Gender</b></label>
  ...
  <div class="container signin">
    <p>Successfully Your Account Created <a href="myproject7.php"> Login Now</a>.</p>
  </div>
</form>
...
$qry="insert into patient_details(Patient_Name,Address,Contact_No,E_mail,Password,Age,Gender)values('$nm','$addr','$cn','$email','$psw',$age,'$gndr')";
